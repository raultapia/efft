...
BENCHMARK_TEMPLATE(BenchmarkFeedWithPacketsFFTW, 128)->Arg(1000)->Arg(5000)->Arg(10000)->Arg(50000)->Arg(100000);
BENCHMARK_TEMPLATE(BenchmarkFeedWithPacketsFFTW, 256)->Arg(1000)->Arg(5000)->Arg(10000)->Arg(50000)->Arg(100000);
...
BENCHMARK_TEMPLATE(BenchmarkFeedWithPackets, 128)->Arg(1000)->Arg(5000)->Arg(10000)->Arg(50000)->Arg(100000);
BENCHMARK_TEMPLATE(BenchmarkFeedWithPackets, 256)->Arg(1000)->Arg(5000)->Arg(10000)->Arg(50000)->Arg(100000);
